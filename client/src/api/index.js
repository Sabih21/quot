...
export const fetchInvoicesByUser = (searchQuery) => API.get(`/invoices`);
...
export const fetchClientsByUser = (searchQuery) => API.get(`/clients/user`);
...
export const fetchProfilesBySearch = (searchQuery) => API.get(`/profiles/search`);
export const fetchProfile = (id) => API.get(`/profiles/${id}`)
export const fetchProfiles = () => API.get('/profiles');
export const fetchProfilesByUser = (searchQuery) => API.get(`/profiles`)
